...
/** This program creates provider report for the manager to see. 
  * Once called, it will create a textfile and save it onto the terminal for it to be sent as email.
...
public class ProviderReport {
  ...
  */
  ...
  /**
   * printProviderReport collects information and writes a file under that provider name. 
   * Its format imitates ChocAn format.
  ...
  public void printServiceData(PrintWriter write) throws IOException {
    for (int x = 0; x < service.size(); x++) {
      ...
      write.println("Date and time data were received by the computer: " 
          + service.get(x).getServiceTime());
