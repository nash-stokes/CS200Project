...
/**
 * The ProviderData class stores personal information of ChocAn Providers. Inherits attributes and
 * methods from the PersonData Class.
 *
 * @author Erik Jones
 */
public class ProviderData extends PersonData {
   ...
   */
  public ProviderData(
      String name, String street, String city, String state, String ZIP, String providerNumber) {
