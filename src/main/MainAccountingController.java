...
public class MainAccountingController {
  ...
  /**
   * This function aggregates the different report generation functions into one, so that they can
   * all be generated in unison with one another without having to run them one-by-one manually.
   */
