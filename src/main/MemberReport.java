...
/**
 * The Member Report class writes individual files for each member that contains their consultation
 * information.
 *
 * @author Lyle Stokes
 */
public class MemberReport {
  ...
  /**
   * Takes a member object to specify which member's report is being generated and all of their
   * info.
   *
   * @param obj
   */
  ...
  /**
   * Creates the individual member files and prints the member data and services provided.
   *
   * @throws IOException
   */
  ...
  /**
   * Iterates through the list of services provided to member and prints details to member's file.
   *
   * @param write
   * @throws IOException
   */
