...
public class ServiceData {
  ...
  /**
   * setter for serviceDate will prompt user to re-enter if given value isn't in the correct format
   *
  ...
  /**
   * setter for serviceTime will prompt user to re-enter if given value isn't in the correct format
   *
  ...
  /**
   * setter for providerNumber will prompt user to re-enter if given value isn't in the correct
   * format
   *
  ...
  /**
   * setter for memberNumber will prompt user to re-enter if given value isn't in the correct format
   *
  ...
  /**
   * setter for serviceCode will prompt user to re-enter if given value isn't in the correct format
   *
  ...
  /**
   * setter for comments will prompt user to re-enter if given value isn't in the correct format
   *
  ...
  /**
   * setter for serviceFee will prompt user to re-enter if given value isn't in the correct format
   *
  ...
  /**
   * setter for memberName will prompt user to re-enter if given value isn't in the correct format
   *
