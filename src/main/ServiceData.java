...
public class ServiceData {
  ...
  */
  public ServiceData(String serviceDate, String serviceTime, String providerNumber,
                     String memberNumber, String serviceCode, String comments, double serviceFee,
                     String memberName, String serviceName, String providerName) {
  ...
  * will prompt user to re-enter if given value isn't in the correct format
   ...
   * will prompt user to re-enter if given value isn't in the correct format
   * @param name the value providerName is to be set to
   */
   ...
   * will prompt user to re-enter if given value isn't in the correct format
   * @param serviceName the value serviceName is to be set to
   */
