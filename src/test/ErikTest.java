...
class ErikTest {
  ...
  /**
   * use 'first' as the name, street, city for the first member use 'second as the name, street,
   * city for the second member use 'AL' as the state use '00000' as the ZIP use '000000000' as the
   * first member number use '123456789' as the second member number delete the first member
   * (000000000)
   */
  @Test
