...
class ProviderControllerTest {
  ...
  /**
   * use 'test' as the name, street, city, state. use '00000' as the ZIP. use '000000000' as the
   * provider number.
   */
  @Test
  ...
  /**
   * use 'first' as the name, street, city for the first provider. use 'second as the name, street,
   * city for the second provider. use 'AL' as the state. use '00000' as the ZIP. use '000000000' as
   * the first provider number. use '123456789' as the second provider number. delete the first
   * provider (000000000).
   */
  @Test
